    ...
    appShell({
      ...
      content: `
        ...
        <section class="more-list">
          ${moreItem({ iconName: 'cart', title: 'Minhas compras', description: 'Consultores, produtos e orçamentos', href: '/compras' })}
          ${moreItem({ iconName: 'users', title: 'Meu espaço de consultor', description: 'Atuação própria, empresas e representantes', href: '/consultor' })}
        </section>
        <section class="more-list">
